WebsocketRails.setup do |config|
  ...
  # config.allowed_origins = ['http://192.241.156.103/', 'http://192.241.156.103:80/', 'http://chess.joahg.com/', 'http://chess.joahg.com:80']
  config.allowed_origins = ['http://0.0.0.0/8080']
